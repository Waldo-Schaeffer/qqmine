...
function html_center () {
    ...
    $sql = 'select gift_time,gift_author,gift_name,gift_number,gift_color,gift_master from ' . $table_name .' where (gift_name <=> "梦幻迷迭香"  or gift_name <=> "梦幻摩天轮"  or gift_name <=> "BUFF梦幻迷迭香"  or gift_name <=> "BUFF梦幻摩天轮" or gift_name <=> "梦幻热气球" or gift_name <=> "BUFF梦幻热气球" or gift_name <=> "星际战舰" or gift_name <=> "BUFF星际战舰") and (gift_master <=> "春哥法力无边" or gift_master <=> "晞秋Ball" or gift_master <=> "TR情谊-春哥" or gift_master <=> "TR情谊-残夜酱" or gift_master <=> "春哥的意大利炮" or gift_master <=> "春哥的法拉利" or gift_master <=> "春哥的布加迪威龙" or gift_master <=> "企鹅电竞沃哥" or gift_master <=> "TR情谊-殷水春") order by gift_time desc limit 0,510';
