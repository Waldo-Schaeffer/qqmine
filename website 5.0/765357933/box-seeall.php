...
function html_center () {
    ...
    # echo $table_name;
    $sql = 'select gift_time,gift_author,gift_name,gift_number,gift_color,gift_master from ' . $table_name .' where (gift_name <=> "梦幻迷迭香"  or gift_name <=> "梦幻摩天轮"  or gift_name <=> "BUFF梦幻迷迭香"  or gift_name <=> "BUFF梦幻摩天轮") and (gift_master  <=> "户外丶大宝哥" or gift_master  <=> "Sog丶龙龙.") order by gift_time desc limit 0,510';
