...
function html_center () {
    ...
    # echo $table_name;
    $sql = 'select gift_time,gift_author,gift_name,gift_number,gift_color,gift_master from ' . $table_name .' where gift_master  <=> "Sog丶龙龙" or gift_master  <=> "户外龙龙钓鱼" order by gift_time desc';# limit 0,10';
